...
public class Questão3_31082021 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("------------------------\n");
        //Media de ganhos
        media(vetGanhos, n, "Ganhos");
        //Media de gastos
        media(vetGastos, n, "Gastos");
        // Media de lucro
        media(vetLucro, n, "Lucro");
    ...
    public static double media(double[] vetor, int n, String type) {
        int i = 0;
        double media = 0;
        for (i = 0; i < n; i++) {
            media = media + vetor[i];
        ...
        media = media/n;
        System.out.printf(" Sua media de " + type + " no ano de 2020 foi de: " + media + "\n");
        return media;
    }
