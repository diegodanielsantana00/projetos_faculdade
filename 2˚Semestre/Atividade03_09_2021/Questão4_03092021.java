...
public class Questão4_03092021 {
    ...
    public static void main(String[] args) {
        ...
        getQTDAlunos(mediaAlu, mediaGeral, n);
    ...
    public static void getQTDAlunos(double[] alunos, double Media, int n) {
        int i = 0;
        double porcentagem = 0;
        for (i = 0; i < n; i++) {
            if (alunos[i] >= Media) {
        ...
        System.out.printf("Quantidades de alunos acima da media é de: " +  porcentagem);
    }
    ...
    public static void maiorValor(double[] alunos, int n) {
        ...
        System.out.printf("Maior media: " +  max);
    }
